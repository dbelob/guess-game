...
public class LocalizationUtilsTest {
    ...
    public static class GetSpeakerNameWithCompanyTest {
        ...
        public static Collection<Object[]> data() {
            ...
            return Arrays.asList(new Object[][]{
                    {new Speaker(0L, "0000.jpg", null, null, null, null, null, false, false), Language.ENGLISH, ""},
                    {new Speaker(0L, "0000.jpg", null, null, null, null, null, false, false), Language.RUSSIAN, ""},
                    {new Speaker(0L, "0000.jpg", FULL_NAME_LOCALE_ITEMS, null, null, null, null, false, false), Language.ENGLISH, "Name"},
                    {new Speaker(0L, "0000.jpg", FULL_NAME_LOCALE_ITEMS, null, null, null, null, false, false), Language.RUSSIAN, "Имя"},
                    {new Speaker(0L, "0000.jpg", FULL_NAME_LOCALE_ITEMS, FULL_COMPANY_LOCALE_ITEMS, null, null, null, false, false), Language.ENGLISH, "Name (Company)"},
                    {new Speaker(0L, "0000.jpg", FULL_NAME_LOCALE_ITEMS, FULL_COMPANY_LOCALE_ITEMS, null, null, null, false, false), Language.RUSSIAN, "Имя (Компания)"},
                    {new Speaker(0L, "0000.jpg", FULL_NAME_LOCALE_ITEMS, ENGLISH_COMPANY_LOCALE_ITEMS, null, null, null, false, false), Language.RUSSIAN, "Имя (Company)"},
                    {new Speaker(0L, "0000.jpg", ENGLISH_NAME_LOCALE_ITEMS, FULL_COMPANY_LOCALE_ITEMS, null, null, null, false, false), Language.RUSSIAN, "Name (Компания)"},
                    {new Speaker(0L, "0000.jpg", ENGLISH_NAME_LOCALE_ITEMS, ENGLISH_COMPANY_LOCALE_ITEMS, null, null, null, false, false), Language.RUSSIAN, "Name (Company)"}
            });
        }
