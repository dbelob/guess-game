...
public class ConferenceDataLoaderTest {
    ...
    class DeleteTalkDuplicatesTest {
        private Stream<Arguments> data() {
            ...
            Talk talk4 = new Talk();
            talk4.setId(4);
            talk4.setName(List.of(new LocaleItem("ru", "name4")));
            ...
            return Stream.of(
                    ...
                    arguments(List.of(talk0, talk4), List.of(talk0, talk4)),
                    arguments(List.of(talk1, talk2, talk3, talk0, talk4), List.of(talk0, talk4))
            );
        }
